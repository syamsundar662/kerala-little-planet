...
const SUPABASE_ANON_KEY=env.VITE_SUPABASE_ANON_KEY??env.NEXT_PUBLIC_SUPABASE_ANON_KEY??(typeof process!=='undefined'?process.env?.NEXT_PUBLIC_SUPABASE_ANON_KEY:undefined);
